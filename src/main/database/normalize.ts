...
/**
 * Port of `App._group_changes()`: buckets the DB's flat "recent changes" feed by game name
 * for display in the Changes dialog. Accepts either `[appid, game, message]` tuples or
 * `"Game - message"` strings, same as the Python version tolerated.
 */
