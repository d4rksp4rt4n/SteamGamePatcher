/**
 * Port of `flatten_game_contents()` from SteamGamePatcher.py.
 *
 ...
 *              anything (".exe", ".zip", "file", null...) — the Python comment notes
 *              "Accept ANY item that has an id", so we don't filter on type here either.
 *
