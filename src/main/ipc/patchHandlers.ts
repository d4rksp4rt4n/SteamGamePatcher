/**
 * IPC surface for phase 4: settings (incl. the Beta Auto-Install toggle) and the
 * download/apply pipeline. Kept separate from ipc/handlers.ts (phase-1 library load)
 * since these are a distinct concern with their own imports.
 */
