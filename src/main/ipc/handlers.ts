/**
 * IPC surface for phase 1. Renderer never touches Node/filesystem directly —
 * it calls these channels through the typed bridge exposed in src/preload.
 */
...
/**
 * Runs the full phase-1 pipeline once: locate Steam, scan installed games, fetch/refresh
 ...
 * this is the direct equivalent of the sequence that used to run inline in `App.__init__`
 * before the Tkinter window was built.
 */
