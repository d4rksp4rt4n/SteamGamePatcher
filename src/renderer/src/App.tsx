...
/**
 * Top-level layout: header (title/search/view toggle) + a two-pane body, the Electron
 * equivalent of the Python version's Treeview/grid on the left and the game-detail
 * frame on the right.
 */
