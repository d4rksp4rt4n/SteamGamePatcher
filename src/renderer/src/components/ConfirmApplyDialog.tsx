...
/**
 * Per the brief: "Do not silently run any patch .exe or write into game folders unless
 * the user has explicitly enabled the Beta toggle AND confirmed a second warning dialog."
 * This is that second dialog — it names the exact game, install path, and files about to
