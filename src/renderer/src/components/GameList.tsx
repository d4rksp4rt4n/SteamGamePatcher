...
/**
 * List view — the Electron equivalent of the Python version's `ttk.Treeview` rows.
 * Row height/columns are simplified relative to Tkinter's multi-column tree, but the
 * same signal (favorite star, dev name, file count, update badge, gold tint) is present.
 */
