import { APP_VERSION, GITHUB_REPO_URL, NUKIGE_STEAM_GROUP_URL } from '@shared/constants'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-bold text-text-bright">Steam Game Patcher</h2>
        ...
        <div className="mt-5 flex flex-col gap-2">
          ...
          <button
            type="button"
            onClick={() => void window.patcher.openExternal(NUKIGE_STEAM_GROUP_URL)}
            className="rounded-md border border-bg-card px-3 py-2 text-sm text-text hover:bg-bg-card"
          >
            Nukige Steam Group
          </button>
