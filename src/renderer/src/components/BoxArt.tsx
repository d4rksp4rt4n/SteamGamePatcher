 ...
 * placeholder — initials over the Steam dark palette — instead of the Python version's
 * bundled `no-box-art.png` + hand-drawn "No Box Art" text, since a CSS/SVG fallback needs
 * no shipped asset and matches the game's own name instead of a generic label.
 *
